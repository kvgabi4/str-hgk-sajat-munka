...
// Create a new person.
controller.post('/',adminOnly, async (req, res, next) => {
...
// Update a person.
controller.put('/:id/:vaccine/:count',adminOnly, async (req, res, next) => {
...
controller.delete('/:vaccine',adminOnly, async (req, res, next) => {
    const vaccine = req.params.vaccine;
